...
public class CreateZipWithOutputStreamsStandardEnc {
	...
	public CreateZipWithOutputStreamsStandardEnc() {
		...
		try {
			...
			filesToAdd.add(new File("d:\\ZipTest\\1.xls"));
			filesToAdd.add(new File("d:\\ZipTest\\2.xls"));
			filesToAdd.add(new File("d:\\ZipTest\\3.xls"));
			...
			outputStream = new ZipOutputStream(new FileOutputStream(new File("d:\\ZipTest\\CreateZipWithOutputStreamsStandardEnc.zip")));
